insert into batches (creation_date, credit_cost, expected_grad_date, "section", department_id, program_id, code)
values
    ('2023-09-01', 1000.00, '2027-05-01', 'P', 1, 1,'B2023A1'),
    ('2023-09-02', 1500.00, '2026-05-01', 'Q', 1, 2,'M2023A1');
